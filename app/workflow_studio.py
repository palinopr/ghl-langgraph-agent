"""
Workflow for LangGraph Studio - without custom checkpointer
Studio handles persistence automatically
"""
...
logger = get_logger("workflow_studio")
...
# Create workflow for Studio - NO CUSTOM CHECKPOINTER
logger.info("Creating workflow for LangGraph Studio")
...
logger.info("Workflow compiled for LangGraph Studio (no custom checkpointer)")
